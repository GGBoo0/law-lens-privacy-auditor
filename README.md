...
2026년 8월 20일 시행 예정인 개인정보 보호법 시행령 개정은 적용 대상의 본인전송요구 방법 반영 필요사항으로 예고하고, 2026년 9월 11일 시행 예정인 개인정보 보호법 개정도 현재 규칙에는 미리 적용하지 않습니다. 법령 메타데이터는 [`lib/legal-baseline.ts`](./lib/legal-baseline.ts)에서 한 번에 관리합니다.
